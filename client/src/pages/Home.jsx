...
function Home() {
  return (
    <div>
      {/* section 1 */}
      <div className="relative mx-auto flex flex-col w-11/12 max-w-[1100px] items-center text-white justify-between ">
        <Link to="/signup">
        ...
        <div className="text-center w-[90%] text-lg font-bold text-[#838894] mt-4 ">
        ...
        <div className=" shadow-blue-300 shadow-2xl mx-3 my-12 ">
        ...
        <div>
          <CodeBlocks
            ...
            backgroundGradient={
              "inset-0 bg-[radial-gradient(ellipse,rgba(59,130,246,0.3),transparent_70%)]"
            }
          />
        </div>
      </div>
